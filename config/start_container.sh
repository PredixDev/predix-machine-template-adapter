...
VM_ARGS="-Dmbs.log.custom=com.prosyst.util.log.buffer.BufferedLogger -Dmbs.log.useEventThread=false -Dmbs.log.file.entriesThreshold=0 -Djava.security.egd=file:///dev/urandom -Dorg.osgi.framework.bootdelegation=mraa.*"
